import { limitLines } from './content'
...
describe('limitLines', () => {
  ...
  it('should truncate when virtual lines exceed maxVirtualLines', () => {
    ...
    const result = limitLines(lines, 30, 15)
  ...
  it('should count long lines as multiple virtual lines', () => {
    ...
    const result = limitLines(input, 30, 2)
  ...
  it('should use custom maxCharsPerLine', () => {
    ...
    const result = limitLines(longLine, 50, 5)
    expect(result).toBe(longLine)
  })

  it('should handle empty string', () => {
    const result = limitLines('')
    expect(result).toBe('')
  })
